...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.translation',  # ADDED: For multi-language support
            ],
        },
    },
]
...
# - On Render: Uses PostgreSQL (with SSL)
# - Locally: Uses SQLite (no setup needed)

# Check if running on Render (Render sets this environment variable automatically)
...
if ON_RENDER and not TESTING:
    ...
    # Local development - use SQLite (simple, no installation needed)
    DATABASES = {
        'default': {
