...
# ─── Database ─────────────────────────────────────────────────────────────
# Use Neon PostgreSQL from .env file, fallback to SQLite for local development
...
if DATABASE_URL and not TESTING:
    # Use Neon PostgreSQL (either locally or on Render)
    DATABASES = {
    ...
    # Fallback to SQLite for local development (no PostgreSQL setup needed)
    DATABASES = {
        'default': {
