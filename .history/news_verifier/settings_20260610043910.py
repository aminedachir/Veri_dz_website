...
MIDDLEWARE = [
    ...
    'core.middleware.LanguageMiddleware',  # ADDED: Language middleware
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.language_context',  # ADDED: Language context processor
            ],
        },
    },
]
...
# ─── Database ─────────────────────────────────────────────────────────────
# Use SQLite locally, PostgreSQL on Render (automatically detected)

# Check if running on Render (Render sets this automatically)
...
# ─── Localisation ─────────────────────────────────────────────────────────────
LANGUAGE_CODE = 'ar-dz'  # Arabic (Algeria)
...
if ON_RENDER and not DEBUG:
    ...
    # Local development - store media files locally
